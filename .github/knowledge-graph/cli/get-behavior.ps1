...
$behaviors = @{
    ...
    'build-session-setup' = @{
        ...
        Steps = @(
            ...
            '        Recommend default from progress.method_proficiency.level for the chosen method.'
            ''
            ...
            '   For deep beat details: pwsh .github/knowledge-graph/cli/get-behavior.ps1 planning'
            ''
    ...
    'handheld-beginner' = @{
        ...
        Steps = @(
            ...
            '   (b) Active method''s progress.method_proficiency.level == "Novice".'
    ...
    'planning' = @{
        ...
        Steps = @(
            ...
            '   • PERSIST: pwsh .github/knowledge-graph/cli/append-session-plan.ps1 -Username $u -ProjectId $p -Beat restate-brief -Value "<their restated goal>"'
            ''
