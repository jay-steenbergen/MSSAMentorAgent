...
$behaviors = @{
    ...
    'planning' = @{
        ...
        Steps = @(
            ...
            '   • Write to session_plan.restated.'
            ''
            ...
            '   • Write list to session_plan.chunks; today''s pick to session_plan.chunks_today.'
            ...
            '   • Write to session_plan.unknowns as [{name, resolution: "research"|"assume"}].'
            ''
            ...
            '   • Write text + mermaid source to session_plan.sketch.'
            ''
            ...
            '   • Write to session_plan.folders = {tree, explanations: {folder: purpose}}.'
            ''
            ...
            '   • Write to session_plan.done_when.'
            ...
            '   • Write to session_plan.risks as [{scenario, handling: "guard"|"crash-loud"|"ignore"|"TODO"}].'
            ''
            ...
            ''
            'METHOD AWARENESS (follow-up — currently generic):'
            '  • TDD reframes beat 7 as "write the failing test that defines done."'
            '  • BDD reframes beat 1 + beat 2 as Given/When/Then.'
            '  • Whiteboard reframes beat 5 as a full architecture diagram.'
            '  • spike-then-refactor reframes beat 3 as "first the throwaway spike, then the clean slice."'
            '  • Each method skill will add skill:method-X -[uses]-> beat:Y edges in a follow-up PR.'
            ''
            'NEVER:'
