...
$behaviors = @{
    ...
    'build-session-setup' = @{
        ...
        Steps = @(
            ...
            '        Recommend default from derived method_proficiency for the chosen method (pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p -View method_proficiency).'
            ''
    ...
    'handheld-beginner' = @{
        ...
        Steps = @(
            ...
            '   (b) Active method''s derived method_proficiency.used_count == 0 (pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p -View method_proficiency — empty means Novice).'
    ...
    'track-concept-proficiency' = @{
        ...
        Steps = @(
            ...
            '  1. Check the derived concept_proficiency view (pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p -View concept_proficiency) for an existing key match.'
            ...
            '    pwsh .github/knowledge-graph/cli/append-event.ps1 -Username $u -ProjectId $p -Type concept_taught -SessionId $sid -Data $d'
            ...
            '    pwsh .github/knowledge-graph/cli/append-event.ps1 -Username $u -ProjectId $p -Type concept_calibrated -SessionId $sid -Data $d'
    ...
    'recall-check-at-open' = @{
        ...
        Steps = @(
            ...
            '      pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p -View concept_proficiency'
    ...
    'callback-prior-concept' = @{
        ...
        Steps = @(
            ...
            '    pwsh .github/knowledge-graph/cli/append-event.ps1 -Username $u -ProjectId $p -Type callback_made -SessionId $sid -Data $d'
    ...
    'goal-progress-at-aar' = @{
        ...
        Steps = @(
            ...
            '      $views = pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p | ConvertFrom-Json'
    ...
    'pre-teach-quiz' = @{
        ...
        Steps = @(
            ...
            '  • SKIP if profile.concept_proficiency[concept_id].tier >= "independent" — calibration is redundant. (Read tier via: pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p -View concept_proficiency)'
            ...
            '    pwsh .github/knowledge-graph/cli/append-event.ps1 -Username $u -ProjectId $p -Type quiz_asked -SessionId $sid -Data $d'
            ...
            '    pwsh .github/knowledge-graph/cli/append-event.ps1 -Username $u -ProjectId $p -Type quiz_answered -SessionId $sid -Data $d'
    ...
    'reappearance-quiz' = @{
        ...
        Steps = @(
            'WHEN to trigger:'
            '  • Mid-build, you are about to write/read code that exercises a concept-id present in the derived concept_proficiency view (pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p -View concept_proficiency).'
    ...
    'cadence-quiz' = @{
        ...
        Steps = @(
            ...
            'PICK CANDIDATE:'
            '  1. Derive the current snapshot: pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $u -ProjectId $p'
