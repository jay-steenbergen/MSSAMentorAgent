...
.EXAMPLE
pwsh .github/knowledge-graph/cli/show-profile.ps1 -Username jay-steenbergen

.EXAMPLE
pwsh .github/knowledge-graph/cli/show-profile.ps1 -Username jay-steenbergen -ProjectId weather-api -Json
#>
