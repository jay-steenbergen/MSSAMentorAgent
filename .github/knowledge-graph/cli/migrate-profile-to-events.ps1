...
.EXAMPLE
    pwsh .github/knowledge-graph/cli/migrate-profile-to-events.ps1 `
...
$appendEvent   = Join-Path $RepoRoot '.github/knowledge-graph/cli/append-event.ps1'
...
Write-Host "Next: pwsh .github/knowledge-graph/cli/derive-views.ps1 -Username $Username -ProjectId $ProjectId -Role $Role"
exit 0
