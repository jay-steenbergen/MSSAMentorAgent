...
.EXAMPLE
pwsh .github/knowledge-graph/cli/audit/find-orphan-markdown.ps1
pwsh .github/knowledge-graph/cli/audit/find-orphan-markdown.ps1 -Quiet
...
Write-Host "             pwsh .github/knowledge-graph/cli/authoring/mentor.ps1 add <type> <slug> -Label '...' -Description '...'" -ForegroundColor Gray
