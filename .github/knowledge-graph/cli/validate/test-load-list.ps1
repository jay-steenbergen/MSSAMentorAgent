...
.EXAMPLE
pwsh .github/knowledge-graph/cli/validate/test-load-list.ps1
pwsh .github/knowledge-graph/cli/validate/test-load-list.ps1 -Quiet
pwsh .github/knowledge-graph/cli/validate/test-load-list.ps1 -UpdateBaseline
...
Write-Host "      2. Update goldens: pwsh .github/knowledge-graph/cli/validate/test-load-list.ps1 -UpdateBaseline"
