...
.EXAMPLE
pwsh .github/knowledge-graph/cli/find-missing-files.ps1
pwsh .github/knowledge-graph/cli/find-missing-files.ps1 -Quiet
...
Write-Host "  - If the artifact was removed: pwsh .github/knowledge-graph/cli/mentor.ps1 remove <id>"
