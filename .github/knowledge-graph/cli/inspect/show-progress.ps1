...
.EXAMPLE
.github/knowledge-graph/cli/inspect/show-progress.ps1 -Username "alex_smith"

.EXAMPLE
.github/knowledge-graph/cli/inspect/show-progress.ps1 -Username "alex_smith" -Track "cloud-app-dev"

.EXAMPLE
.github/knowledge-graph/cli/inspect/show-progress.ps1 -Username "alex_smith" -Json
#>
