# Test: knowledge-graph-management skill

**Type:** Behavioral
**Tests:** method/skill `knowledge-graph-management`
**Spec:** `.github/skills/knowledge-graph-management/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `knowledge-graph-management` method/skill is the active skill for the session
...
**User prompt:**
```Let's work on knowledge-graph-management skill.
```
**OR user action:** Picks `knowledge-graph-management` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/knowledge-graph-management/SKILL.md` step by step.
