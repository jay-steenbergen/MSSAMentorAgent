# Test: wbd-capstone-present-a-system

**Type:** Behavioral
**Tests:** skill `wbd-capstone-present-a-system`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-capstone-present-a-system/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-capstone-present-a-system` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-capstone-present-a-system.
```
**OR user action:** Picks `wbd-capstone-present-a-system` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-capstone-present-a-system/SKILL.md` step by step.
