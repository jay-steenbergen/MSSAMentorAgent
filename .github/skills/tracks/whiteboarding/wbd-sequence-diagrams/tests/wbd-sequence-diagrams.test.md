# Test: wbd-sequence-diagrams

**Type:** Behavioral
**Tests:** skill `wbd-sequence-diagrams`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-sequence-diagrams/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-sequence-diagrams` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-sequence-diagrams.
```
**OR user action:** Picks `wbd-sequence-diagrams` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-sequence-diagrams/SKILL.md` step by step.
