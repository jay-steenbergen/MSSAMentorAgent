# Test: wbd-mermaid-as-code

**Type:** Behavioral
**Tests:** skill `wbd-mermaid-as-code`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-mermaid-as-code/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-mermaid-as-code` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-mermaid-as-code.
```
**OR user action:** Picks `wbd-mermaid-as-code` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-mermaid-as-code/SKILL.md` step by step.
