# Test: wbd-drawio-for-polished-diagrams

**Type:** Behavioral
**Tests:** skill `wbd-drawio-for-polished-diagrams`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-drawio-for-polished-diagrams/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-drawio-for-polished-diagrams` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-drawio-for-polished-diagrams.
```
**OR user action:** Picks `wbd-drawio-for-polished-diagrams` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-drawio-for-polished-diagrams/SKILL.md` step by step.
