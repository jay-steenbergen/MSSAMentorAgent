# Test: wbd-whiteboard-foundations

**Type:** Behavioral
**Tests:** skill `wbd-whiteboard-foundations`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-whiteboard-foundations/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-whiteboard-foundations` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-whiteboard-foundations.
```
**OR user action:** Picks `wbd-whiteboard-foundations` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-whiteboard-foundations/SKILL.md` step by step.
