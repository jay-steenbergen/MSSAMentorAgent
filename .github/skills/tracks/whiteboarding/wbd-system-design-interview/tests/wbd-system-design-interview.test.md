# Test: wbd-system-design-interview

**Type:** Behavioral
**Tests:** skill `wbd-system-design-interview`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-system-design-interview/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-system-design-interview` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-system-design-interview.
```
**OR user action:** Picks `wbd-system-design-interview` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-system-design-interview/SKILL.md` step by step.
