# Test: wbd-state-machines-and-flowcharts

**Type:** Behavioral
**Tests:** skill `wbd-state-machines-and-flowcharts`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-state-machines-and-flowcharts/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-state-machines-and-flowcharts` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-state-machines-and-flowcharts.
```
**OR user action:** Picks `wbd-state-machines-and-flowcharts` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-state-machines-and-flowcharts/SKILL.md` step by step.
