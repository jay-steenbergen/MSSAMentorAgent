# Test: wbd-entity-relationship-diagrams

**Type:** Behavioral
**Tests:** skill `wbd-entity-relationship-diagrams`
**Spec:** `.github/skills/tracks/whiteboarding/wbd-entity-relationship-diagrams/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `wbd-entity-relationship-diagrams` skill is the active skill for the session
...
**User prompt:**
```Let's work on wbd-entity-relationship-diagrams.
```
**OR user action:** Picks `wbd-entity-relationship-diagrams` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/wbd-entity-relationship-diagrams/SKILL.md` step by step.
