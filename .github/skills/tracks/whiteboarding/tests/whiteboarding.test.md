...
**Type:** Behavioral
**Tests:** track `whiteboarding`
**Spec:** `.github/skills/tracks/whiteboarding/README.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `whiteboarding` track is the active skill for the session
...
**User prompt:**
```Let's work on whiteboarding.
```
**OR user action:** Picks `whiteboarding` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/whiteboarding/README.md` step by step.
