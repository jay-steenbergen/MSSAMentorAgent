# Test: cad-todo-api-auth

**Type:** Behavioral
**Tests:** skill `cad-todo-api-auth`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-todo-api-auth/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-todo-api-auth` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-todo-api-auth.
```
**OR user action:** Picks `cad-todo-api-auth` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-todo-api-auth/SKILL.md` step by step.
