# Test: cad-function-queue-trigger

**Type:** Behavioral
**Tests:** skill `cad-function-queue-trigger`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-function-queue-trigger/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-function-queue-trigger` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-function-queue-trigger.
```
**OR user action:** Picks `cad-function-queue-trigger` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-function-queue-trigger/SKILL.md` step by step.
