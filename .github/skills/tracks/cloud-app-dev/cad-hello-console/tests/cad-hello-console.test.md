# Test: cad-hello-console

**Type:** Behavioral
**Tests:** skill `cad-hello-console`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-hello-console/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-hello-console` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-hello-console.
```
**OR user action:** Picks `cad-hello-console` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-hello-console/SKILL.md` step by step.
