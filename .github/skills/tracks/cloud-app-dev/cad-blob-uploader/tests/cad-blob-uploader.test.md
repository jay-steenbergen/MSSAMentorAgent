# Test: cad-blob-uploader

**Type:** Behavioral
**Tests:** skill `cad-blob-uploader`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-blob-uploader/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-blob-uploader` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-blob-uploader.
```
**OR user action:** Picks `cad-blob-uploader` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-blob-uploader/SKILL.md` step by step.
