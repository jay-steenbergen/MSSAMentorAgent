# Test: cad-cicd-pipeline

**Type:** Behavioral
**Tests:** skill `cad-cicd-pipeline`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-cicd-pipeline/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-cicd-pipeline` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-cicd-pipeline.
```
**OR user action:** Picks `cad-cicd-pipeline` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-cicd-pipeline/SKILL.md` step by step.
