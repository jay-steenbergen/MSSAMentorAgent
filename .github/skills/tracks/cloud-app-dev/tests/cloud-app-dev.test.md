...
**Type:** Behavioral
**Tests:** track `cloud-app-dev`
**Spec:** `.github/skills/tracks/cloud-app-dev/README.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cloud-app-dev` track is the active skill for the session
...
**User prompt:**
```Let's work on cloud-app-dev.
```
**OR user action:** Picks `cloud-app-dev` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/README.md` step by step.
