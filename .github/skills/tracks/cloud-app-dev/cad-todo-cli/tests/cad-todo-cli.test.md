...
**Type:** Behavioral
**Tests:** skill `cad-todo-cli`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-todo-cli/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-todo-cli` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-todo-cli.
```
**OR user action:** Picks `cad-todo-cli` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-todo-cli/SKILL.md` step by step.
