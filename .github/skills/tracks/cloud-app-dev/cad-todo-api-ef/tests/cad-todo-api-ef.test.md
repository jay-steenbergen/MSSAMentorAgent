# Test: cad-todo-api-ef

**Type:** Behavioral
**Tests:** skill `cad-todo-api-ef`
**Spec:** `.github/skills/tracks/cloud-app-dev/cad-todo-api-ef/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cad-todo-api-ef` skill is the active skill for the session
...
**User prompt:**
```Let's work on cad-todo-api-ef.
```
**OR user action:** Picks `cad-todo-api-ef` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cloud-app-dev/cad-todo-api-ef/SKILL.md` step by step.
