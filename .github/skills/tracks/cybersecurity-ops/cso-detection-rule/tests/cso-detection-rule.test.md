# Test: cso-detection-rule

**Type:** Behavioral
**Tests:** skill `cso-detection-rule`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-detection-rule/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-detection-rule` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-detection-rule.
```
**OR user action:** Picks `cso-detection-rule` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-detection-rule/SKILL.md` step by step.
