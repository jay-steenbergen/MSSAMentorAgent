# Test: cso-threat-intel-integration

**Type:** Behavioral
**Tests:** skill `cso-threat-intel-integration`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-threat-intel-integration/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-threat-intel-integration` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-threat-intel-integration.
```
**OR user action:** Picks `cso-threat-intel-integration` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-threat-intel-integration/SKILL.md` step by step.
