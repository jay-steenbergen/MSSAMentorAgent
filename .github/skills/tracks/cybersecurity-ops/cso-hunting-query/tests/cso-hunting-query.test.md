# Test: cso-hunting-query

**Type:** Behavioral
**Tests:** skill `cso-hunting-query`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-hunting-query/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-hunting-query` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-hunting-query.
```
**OR user action:** Picks `cso-hunting-query` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-hunting-query/SKILL.md` step by step.
