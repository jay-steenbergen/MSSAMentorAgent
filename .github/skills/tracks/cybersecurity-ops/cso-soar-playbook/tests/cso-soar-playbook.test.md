# Test: cso-soar-playbook

**Type:** Behavioral
**Tests:** skill `cso-soar-playbook`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-soar-playbook/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-soar-playbook` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-soar-playbook.
```
**OR user action:** Picks `cso-soar-playbook` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-soar-playbook/SKILL.md` step by step.
