# Test: cso-sentinel-workspace

**Type:** Behavioral
**Tests:** skill `cso-sentinel-workspace`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-sentinel-workspace/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-sentinel-workspace` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-sentinel-workspace.
```
**OR user action:** Picks `cso-sentinel-workspace` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-sentinel-workspace/SKILL.md` step by step.
