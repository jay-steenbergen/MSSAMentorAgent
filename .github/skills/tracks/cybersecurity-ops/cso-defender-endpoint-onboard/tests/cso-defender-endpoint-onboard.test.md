# Test: cso-defender-endpoint-onboard

**Type:** Behavioral
**Tests:** skill `cso-defender-endpoint-onboard`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-defender-endpoint-onboard/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-defender-endpoint-onboard` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-defender-endpoint-onboard.
```
**OR user action:** Picks `cso-defender-endpoint-onboard` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-defender-endpoint-onboard/SKILL.md` step by step.
