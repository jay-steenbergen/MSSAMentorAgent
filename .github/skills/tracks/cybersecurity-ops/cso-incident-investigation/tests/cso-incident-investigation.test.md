# Test: cso-incident-investigation

**Type:** Behavioral
**Tests:** skill `cso-incident-investigation`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-incident-investigation/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-incident-investigation` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-incident-investigation.
```
**OR user action:** Picks `cso-incident-investigation` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-incident-investigation/SKILL.md` step by step.
