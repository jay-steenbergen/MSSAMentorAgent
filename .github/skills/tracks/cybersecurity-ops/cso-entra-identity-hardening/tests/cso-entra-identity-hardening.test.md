# Test: cso-entra-identity-hardening

**Type:** Behavioral
**Tests:** skill `cso-entra-identity-hardening`
**Spec:** `.github/skills/tracks/cybersecurity-ops/cso-entra-identity-hardening/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cso-entra-identity-hardening` skill is the active skill for the session
...
**User prompt:**
```Let's work on cso-entra-identity-hardening.
```
**OR user action:** Picks `cso-entra-identity-hardening` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/cso-entra-identity-hardening/SKILL.md` step by step.
