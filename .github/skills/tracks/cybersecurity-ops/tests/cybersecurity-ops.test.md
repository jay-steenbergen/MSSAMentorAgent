# Test: cybersecurity-ops

**Type:** Behavioral
**Tests:** track `cybersecurity-ops`
**Spec:** `.github/skills/tracks/cybersecurity-ops/README.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `cybersecurity-ops` track is the active skill for the session
...
**User prompt:**
```Let's work on cybersecurity-ops.
```
**OR user action:** Picks `cybersecurity-ops` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/cybersecurity-ops/README.md` step by step.
