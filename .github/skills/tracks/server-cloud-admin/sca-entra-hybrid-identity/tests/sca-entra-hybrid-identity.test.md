# Test: sca-entra-hybrid-identity

**Type:** Behavioral
**Tests:** skill `sca-entra-hybrid-identity`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-entra-hybrid-identity/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-entra-hybrid-identity` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-entra-hybrid-identity.
```
**OR user action:** Picks `sca-entra-hybrid-identity` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-entra-hybrid-identity/SKILL.md` step by step.
