# Test: sca-arm-bicep-iac

**Type:** Behavioral
**Tests:** skill `sca-arm-bicep-iac`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-arm-bicep-iac/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-arm-bicep-iac` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-arm-bicep-iac.
```
**OR user action:** Picks `sca-arm-bicep-iac` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-arm-bicep-iac/SKILL.md` step by step.
