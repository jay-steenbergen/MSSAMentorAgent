# Test: sca-azure-vnet-vm

**Type:** Behavioral
**Tests:** skill `sca-azure-vnet-vm`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-azure-vnet-vm/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-azure-vnet-vm` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-azure-vnet-vm.
```
**OR user action:** Picks `sca-azure-vnet-vm` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-azure-vnet-vm/SKILL.md` step by step.
