...
**Type:** Behavioral
**Tests:** skill `sca-monitoring`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-monitoring/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-monitoring` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-monitoring.
```
**OR user action:** Picks `sca-monitoring` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-monitoring/SKILL.md` step by step.
