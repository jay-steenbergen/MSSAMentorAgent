# Test: sca-server-vm-setup

**Type:** Behavioral
**Tests:** skill `sca-server-vm-setup`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-server-vm-setup/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-server-vm-setup` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-server-vm-setup.
```
**OR user action:** Picks `sca-server-vm-setup` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-server-vm-setup/SKILL.md` step by step.
