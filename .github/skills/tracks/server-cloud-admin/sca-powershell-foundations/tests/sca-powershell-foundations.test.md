# Test: sca-powershell-foundations

**Type:** Behavioral
**Tests:** skill `sca-powershell-foundations`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-powershell-foundations/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-powershell-foundations` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-powershell-foundations.
```
**OR user action:** Picks `sca-powershell-foundations` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-powershell-foundations/SKILL.md` step by step.
