# Test: sca-storage-and-backup

**Type:** Behavioral
**Tests:** skill `sca-storage-and-backup`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-storage-and-backup/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-storage-and-backup` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-storage-and-backup.
```
**OR user action:** Picks `sca-storage-and-backup` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-storage-and-backup/SKILL.md` step by step.
