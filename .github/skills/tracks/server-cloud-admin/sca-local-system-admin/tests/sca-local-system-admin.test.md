# Test: sca-local-system-admin

**Type:** Behavioral
**Tests:** skill `sca-local-system-admin`
**Spec:** `.github/skills/tracks/server-cloud-admin/sca-local-system-admin/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `sca-local-system-admin` skill is the active skill for the session
...
**User prompt:**
```Let's work on sca-local-system-admin.
```
**OR user action:** Picks `sca-local-system-admin` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/server-cloud-admin/sca-local-system-admin/SKILL.md` step by step.
