# Test: ghc-mcp-tools-integration

**Type:** Behavioral
**Tests:** skill `ghc-mcp-tools-integration`
**Spec:** `.github/skills/tracks/github-copilot/ghc-mcp-tools-integration/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-mcp-tools-integration` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-mcp-tools-integration.
```
**OR user action:** Picks `ghc-mcp-tools-integration` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-mcp-tools-integration/SKILL.md` step by step.
