# Test: ghc-prompting-for-completions

**Type:** Behavioral
**Tests:** skill `ghc-prompting-for-completions`
**Spec:** `.github/skills/tracks/github-copilot/ghc-prompting-for-completions/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-prompting-for-completions` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-prompting-for-completions.
```
**OR user action:** Picks `ghc-prompting-for-completions` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-prompting-for-completions/SKILL.md` step by step.
