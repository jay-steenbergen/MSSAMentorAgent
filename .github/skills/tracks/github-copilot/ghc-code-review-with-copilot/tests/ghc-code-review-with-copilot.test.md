# Test: ghc-code-review-with-copilot

**Type:** Behavioral
**Tests:** skill `ghc-code-review-with-copilot`
**Spec:** `.github/skills/tracks/github-copilot/ghc-code-review-with-copilot/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-code-review-with-copilot` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-code-review-with-copilot.
```
**OR user action:** Picks `ghc-code-review-with-copilot` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-code-review-with-copilot/SKILL.md` step by step.
