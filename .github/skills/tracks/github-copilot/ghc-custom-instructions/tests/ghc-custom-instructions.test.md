# Test: ghc-custom-instructions

**Type:** Behavioral
**Tests:** skill `ghc-custom-instructions`
**Spec:** `.github/skills/tracks/github-copilot/ghc-custom-instructions/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-custom-instructions` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-custom-instructions.
```
**OR user action:** Picks `ghc-custom-instructions` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-custom-instructions/SKILL.md` step by step.
