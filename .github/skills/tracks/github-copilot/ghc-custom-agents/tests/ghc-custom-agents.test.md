# Test: ghc-custom-agents

**Type:** Behavioral
**Tests:** skill `ghc-custom-agents`
**Spec:** `.github/skills/tracks/github-copilot/ghc-custom-agents/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-custom-agents` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-custom-agents.
```
**OR user action:** Picks `ghc-custom-agents` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-custom-agents/SKILL.md` step by step.
