# Test: ghc-chat-driven-debugging

**Type:** Behavioral
**Tests:** skill `ghc-chat-driven-debugging`
**Spec:** `.github/skills/tracks/github-copilot/ghc-chat-driven-debugging/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-chat-driven-debugging` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-chat-driven-debugging.
```
**OR user action:** Picks `ghc-chat-driven-debugging` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-chat-driven-debugging/SKILL.md` step by step.
