# Test: ghc-test-generation

**Type:** Behavioral
**Tests:** skill `ghc-test-generation`
**Spec:** `.github/skills/tracks/github-copilot/ghc-test-generation/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-test-generation` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-test-generation.
```
**OR user action:** Picks `ghc-test-generation` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-test-generation/SKILL.md` step by step.
