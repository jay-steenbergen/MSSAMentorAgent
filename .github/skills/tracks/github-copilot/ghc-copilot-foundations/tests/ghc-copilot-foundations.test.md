# Test: ghc-copilot-foundations

**Type:** Behavioral
**Tests:** skill `ghc-copilot-foundations`
**Spec:** `.github/skills/tracks/github-copilot/ghc-copilot-foundations/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-copilot-foundations` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-copilot-foundations.
```
**OR user action:** Picks `ghc-copilot-foundations` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-copilot-foundations/SKILL.md` step by step.
