# Test: ghc-prompt-files

**Type:** Behavioral
**Tests:** skill `ghc-prompt-files`
**Spec:** `.github/skills/tracks/github-copilot/ghc-prompt-files/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ghc-prompt-files` skill is the active skill for the session
...
**User prompt:**
```Let's work on ghc-prompt-files.
```
**OR user action:** Picks `ghc-prompt-files` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/ghc-prompt-files/SKILL.md` step by step.
