...
**Type:** Behavioral
**Tests:** track `github-copilot`
**Spec:** `.github/skills/tracks/github-copilot/README.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `github-copilot` track is the active skill for the session
...
**User prompt:**
```Let's work on github-copilot.
```
**OR user action:** Picks `github-copilot` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/tracks/github-copilot/README.md` step by step.
