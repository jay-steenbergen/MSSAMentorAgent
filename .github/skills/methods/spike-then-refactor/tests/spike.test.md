# Test: spike-then-refactor skill

**Type:** Behavioral
**Tests:** method/skill `spike`
**Spec:** `.github/skills/methods/spike-then-refactor/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `spike` method/skill is the active skill for the session
...
**User prompt:**
```Let's work on spike-then-refactor skill.
```
**OR user action:** Picks `spike` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/methods/spike-then-refactor/SKILL.md` step by step.
