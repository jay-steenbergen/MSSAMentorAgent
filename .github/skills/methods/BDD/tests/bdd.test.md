...
**Type:** Behavioral
**Tests:** method/skill `bdd`
**Spec:** `.github/skills/methods/BDD/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `bdd` method/skill is the active skill for the session
...
**User prompt:**
```Let's work on BDD skill.
```
**OR user action:** Picks `bdd` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/methods/BDD/SKILL.md` step by step.
