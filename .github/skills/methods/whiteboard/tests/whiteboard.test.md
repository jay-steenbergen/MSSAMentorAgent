...
**Type:** Behavioral
**Tests:** skill `whiteboard`
**Spec:** `.github/skills/methods/whiteboard/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `whiteboard` skill is the active skill for the session
...
**User prompt:**
```Let's work on whiteboard.
```
**OR user action:** Picks `whiteboard` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/methods/whiteboard/SKILL.md` step by step.
