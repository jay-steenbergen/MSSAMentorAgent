# Test: ride-along skill (default method)

**Type:** Behavioral
**Tests:** skill `ride-along`
**Spec:** `.github/skills/methods/ride-along/SKILL.md`
**Created:** 2026-06-04
...
**Given:**
- Mentor agent loaded
- `ride-along` skill is the active skill for the session
...
**User prompt:**
```Let's work on ride-along skill (default method).
```
**OR user action:** Picks `ride-along` from the relevant picker.
...
2. Walk the protocol defined in `.github/skills/methods/ride-along/SKILL.md` step by step.
